...
class Module(object):
    def __init__(self):
        ...
        self.early_stopping = tf.keras.callbacks.EarlyStopping(patience=20, monitor="val_accuracy")
        self.compile_model()
    ...
    def create_model(self):
        ...
        self.model = tf.keras.models.Sequential(
            [
                ...
                tf.keras.layers.Dense(fc_classes, activation=fc_activation,  dtype='float32',)
            ]
        )
