...
import pandas as pd
import numpy as np
path = r"C:\Users\g728v562\Documents\datasets\RAF Face\basic\Image\aligned\\"
import os
...
def main(v):
    ...
    df = pd.read_csv(r"C:\Users\g728v562\Documents\datasets\RAF Face\basic\raf_basic_all.csv")
    from sklearn.model_selection import train_test_split
    _, df = train_test_split(df, test_size=0.2, random_state=42)
    overall_y_pred = []
    overall_y_true = []
    accs = []
    for RACE in ["Caucasian", "African American", "Asian"]:
        df_ = df[df.race == RACE]
        for GENDER in ["Male", "Female"]:
            ...
            paths = [os.path.join(r"C:\Users\g728v562\Documents\datasets\RAF Face\basic\Image\aligned", x) for x in paths]
